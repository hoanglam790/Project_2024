  ...
  return (
    <><div className='header_top'>
      ...
      <div className='container absolute left-2/4 z-10 mx-auto -translate-x-2/4 p-4'>
        <nav className='block w-full max-w-screen-2xl rounded-xl bg-transparent text-white shadow-none p-1'>
          <div className='container mx-auto flex items-center justify-between text-black'>
            ...
            <div className='hidden gap-2 lg:flex'>
              ...
              <a href='/cart'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="file: mt-4 h-6 w-6 ml-2">
      ...
      <div div className='relative flex h-screen content-center items-center justify-center pt-48 pb-16 w-full bg-gray-100'>
        <img className='opacity-100' alt='slide03' src={Image1} draggable='false '/>        
      </div>     
    </>
  )
}
