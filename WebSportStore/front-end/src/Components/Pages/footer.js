                ...
                <div className='flex flex-wrap text-center lg:text-left'>
                    ...
                    <div className='w-full px-4 lg:w-6/12'>
                        ...
                        <p className='block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-500 lg:w-2/5'>
                            Chào mừng mọi người đến với cửa hàng thể thao của chúng tôi. Trang web chuyên cung cấp những sản phẩm chất lượng cao, giá cả phải chăng và phù hợp với tất cả các đối tượng, chỉ cần bạn yêu thích thể thao và có nhu cầu mua sắm. Khám phá ngay !
                        </p>
